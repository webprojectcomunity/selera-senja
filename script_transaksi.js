        ...
        async function prosesPembayaranAkhir() {
            ...
            try {
                ...
                if (result && (result.success || result.status === 'success')) {
                    ...
                    localStorage.removeItem('checkout_items'); // Bersihkan cache checkout aktif
                    ...
                    if (metodePembayaran === 'QRIS') {
                        ...
                        window.location.replace('qris_payment.html'); // Arahkan ke halaman scan QRIS
                    } else {
                        alert("Pesanan berhasil dibuat! Status pesanan: Sedang Dikemas.");
                        window.location.replace('order_status.html'); // Arahkan langsung ke status pesanan
                    }
