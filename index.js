...
// Jalankan slider dan event binding begitu halaman selesai dimuat
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (formLogin) formLogin.onsubmit = prosesLogin;
    if (formRegister) formRegister.onsubmit = prosesDaftar;
});
